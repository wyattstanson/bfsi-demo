"""Acceptance: exactly one append-only audit row per decision, 16 fields."""
...
def test_one_audit_row_per_decision(client, party_id):
    ...
    r = client.post("/decide", json={"party_id": party_id, "channel": "app",
    ...
    # Snapshot + versions were captured for reproducibility.
